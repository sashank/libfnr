...
pkgdatadir = $(datadir)/fnr
pkgincludedir = $(includedir)/fnr
pkglibdir = $(libdir)/fnr
pkglibexecdir = $(libexecdir)/fnr
...
am__aclocal_m4_deps = $(top_srcdir)/config/check_ssl.m4 \
...
OBJEXT = o
PACKAGE = fnr
PACKAGE_BUGREPORT = libfnr-dev@external.cisco.com
PACKAGE_NAME = fnr
PACKAGE_STRING = fnr 1.0.0
PACKAGE_TARNAME = fnr
PACKAGE_URL = 
